...
void get_traces(const double * jac_a, const double * jac_b, double traces[9][4]){
    for (int a = 0; a < 3; a++) {
        for (int b = 0; b < 3; b++) {
            traces[3*a + b][0] = jac_a[2*a + 0] * jac_b[2*b + 0];
            traces[3*a + b][1] = jac_a[2*a + 1] * jac_b[2*b + 0];
            traces[3*a + b][2] = jac_a[2*a + 0] * jac_b[2*b + 1];
            traces[3*a + b][3] = jac_a[2*a + 1] * jac_b[2*b + 1];
        }
    }
}
