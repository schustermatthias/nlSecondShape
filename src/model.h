 ...
 * of shape d x d in case of peridynamics.
 */
void kernel_constant_neumann(const double * x, long labelx, const double * y, long labely, const MeshType &mesh,
                             double * kernel_val);
void kernel_schwarz_neumann(const double * x, long labelx, const double * y, long labely, const MeshType &mesh,
                            double * kernel_val);
...
void kernel_integrable_unsym_1(const double * x, long labelx, const double * y, long labely, const MeshType &mesh,
                               double * kernel_val);

void kernel_integrable_unsym_2(const double * x, long labelx, const double * y, long labely, const MeshType &mesh,
                               double * kernel_val);
